  ...
  <nav class="navbar" :class="{ change_navbar: scrollPosition > 10 }">
    <div class="navbar__list">
      ...
      <div class="navbar__list__container navbar__button">
        <a :href="'/login'" v-on:click.prevent="goToLogin()" class="cta">
          <span :class="{ text_color: scrollPosition > 10 }">Mijn walks</span>
          <svg
            width="13px"
            height="10px"
            viewBox="0 0 13 10"
      ...
      <div class="navbar__list__container hamburger">
        <div id="hamburger-icon" v-on:click="toggleMobileMenu()">
          <span :class="{ white_hamburger: scrollPosition > 10 }"></span>
          <span :class="{ white_hamburger: scrollPosition > 10 }"></span>
          <span :class="{ white_hamburger: scrollPosition > 10 }"></span>
        </div>
      </div>
