<template>
    <section class="horeca">
        ...
        <div class="header mb-100">
            <h1 class="header--title">Deelnemende horeca</h1>
            <p class="header--sub">
                Scroll naar beneden om kennis te maken met alle deelnemende
                horecagelegenheden!
            </p>
        </div>
...
.locatie_gelegenheid:hover {
    transform: scale(1.1);
}
.locatie_gelegenheid a {
    text-decoration: none;
}
.locatie_gelegenheid--image {
    width: 100px;
    height: auto;
    border-radius: 50%;
    margin-bottom: 20px;
...
.locatie_gelegenheid--image:hover {
    transform: rotate(360deg);
}
.locatie_gelegenheid--title {
    color: #f59dcc;
    font-weight: 700;
    font-size: 26px;
    margin-bottom: 10px;
...
.locatie_gelegenheid--title:hover {
    color: #ff59b2;
}
.locatie_gelegenheid--sub {
    color: #f59dcc;
    font-weight: 500;
    font-size: 20px;
    margin-bottom: 10px;
}
.locatie_gelegenheid--socials {
    margin-bottom: 10px;
}
.icon {
    margin: 0 5px;
